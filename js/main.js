...
var TEAM = {
  mauricio: { name: 'Mauricio Rodriguez', initial: 'M', role_en: 'CEO', role_es: 'CEO',
    bio_en: 'Founder & CEO of Aypex. Mauricio spent 10+ years as a QA Automation Engineer at multinational companies — building automated testing across web, mobile and backend where shipping broken code was never an option. Along the way he worked with teams like Ualá (fintech), Opratel (telecommunications), DGUIAF (Government of Argentina) and Clue Insights.\n\nAfter years scaling quality for large, global teams, he moved from Argentina to Asia and founded Aypex with a single idea: build software and tailor-made solutions that truly fit the people who use them. He is also the creator of Khronos and Koibranch — his own developer tools.',
    bio_es: 'Fundador y CEO de Aypex. Mauricio pasó más de 10 años como ingeniero de QA Automation en empresas multinacionales — construyendo testing automatizado en web, mobile y backend, donde no había lugar para el código roto. En ese camino trabajó con equipos como Ualá (fintech), Opratel (telecomunicaciones), DGUIAF (Gobierno de Argentina) y Clue Insights.\n\nTras años escalando la calidad de grandes equipos globales, se mudó de Argentina a Asia y fundó Aypex con una sola idea: crear software y soluciones a medida que realmente se ajusten a las personas que los usan. Además es el creador de Khronos y Koibranch, sus propias herramientas para desarrolladores.',
  },

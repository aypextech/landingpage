...
var TEAM = {
  ...
  ezequiel: { name: 'Ezequiel Rodriguez', initial: 'E', role_en: 'Software Engineer', role_es: 'Ingeniero de Software',
    bio_en: 'Software engineer at Aypex, building web and mobile products and the automation behind them — turning requirements into reliable, well-tested features our clients depend on.',
    bio_es: 'Ingeniero de software en Aypex. Construye productos web y mobile y la automatización que los respalda — convirtiendo requerimientos en funcionalidades confiables y bien testeadas en las que confían nuestros clientes.' },
...
var SERVICE = {
  web: { tag_en: 'Khronos suite', tag_es: 'Suite Khronos',
  ...
  mobile: { tag_en: 'Khronos suite', tag_es: 'Suite Khronos',
  ...
  api: { tag_en: 'Khronos suite', tag_es: 'Suite Khronos',
  ...
  performance: { tag_en: 'Khronos suite', tag_es: 'Suite Khronos',
  ...
  accessibility: { tag_en: 'Khronos suite', tag_es: 'Suite Khronos',
  ...
  pentesting: { soon: true, tag_en: 'Coming soon', tag_es: 'Próximamente',
  ...
  'web-design': { tag_en: 'Design &amp; build', tag_es: 'Diseño y desarrollo',
  ...
  crm: { tag_en: 'Flagship product', tag_es: 'Producto estrella',
  ...
  custom: { tag_en: 'Tailor-made', tag_es: 'A medida',
